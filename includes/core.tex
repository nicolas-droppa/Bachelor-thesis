...
Analogicky pre úpravy údajov sa používajú príkazy INSERT, UPDATE a DELETE, pričom aj tu sa odporúčajú prepared 
statements na zabezpečenie správnej sanitizácie vstupov.
...
a potom následne pre daný ``objekt'' metódy pre vykonanie dotazov ako môžeme pozorovať na následovných ukážkach X a Y.
