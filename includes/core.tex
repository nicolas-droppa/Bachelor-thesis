...
to býva u zvyčajných webstránok. Pri používateľovej návšteve PWA bude zaregistrovaný service worker, DOPLŇ OBRÁZOK, ktorý deteguje a reaguje na
...
pre takých používateľov ktorý nie sú v daný moment propojený k internetu.
